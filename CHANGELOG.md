...
- Update scripts and analysis for August forecast projection. ([@ezuetell](https://github.com/ezuetell), [PR#23](https://github.com/ClimateImpactLab/poreallas/pull/23))
...
[Unreleased]: https://github.com/climateimpactlab/poreallas/compare/v0.4.0...HEAD
